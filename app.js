const DATA_URL = "/notion_technical_questions_final.txt?v=20260810-four-way-keep-alive-v1";
const QUIZ_BANK_URL = "/quiz-bank-v2.json?v=20260810-four-way-keep-alive-v1";
